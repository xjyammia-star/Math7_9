...
const AREA_PERIMETER_SCENES = {
  ...
  parallelogram: [
    { zh: '广告牌', en: 'billboard' },
    { zh: '风筝', en: 'kite' },
    { zh: '铺砖区域', en: 'tiled area' },
    { zh: '帆布棚', en: 'canvas awning' },
    { zh: '窗帘', en: 'curtain' },
  ],
  triangle: [
  ...
  annulus: [
    { zh: '跑道', en: 'track' },
    { zh: '环形花园', en: 'ring-shaped garden' },
    { zh: '靶环', en: 'target ring' },
    { zh: '环形步道', en: 'ring walkway' },
    { zh: '喷泉边缘', en: 'fountain border' },
  ],
  sector: [
    { zh: '花坛', en: 'flower bed' },
    { zh: '喷泉', en: 'fountain' },
    { zh: '披萨切片', en: 'pizza slice' },
    { zh: '草坪', en: 'lawn' },
